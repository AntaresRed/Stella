...
f = open(r'G:\Desktop Folders\Programming\Coding file\Bots\Stella\Rules.txt')
rules = f.readlines()

#Load API KEY from json file (One secure way. Dont just put your key in script)
with open("G:/Desktop Folders/Programming/Coding file/Bots/Stella/token.json", "r") as file:
